    ...
    $('.colors-item').each(function(){
        ...
        switch(type){
            case 'Standart':
				if (curr == 'byn'){
					disc_val_1b = 0; /* 10% */
					disc_val_2b = 0; /* 15.294 */
					disc_val_3b = 0; /* 17.647 */
					disc_val_4b = 0; /* 20 */
            ...
            case 'Premium':
				if (curr == 'byn'){
					disc_val_1b = 0; /* 10% */
					disc_val_2b = 0; /* 14,1 до 1 знака посл запятой */
					disc_val_3b = 0; /* 16.6 до 1 знака посл запятой*/
					disc_val_4b = 0; /* 19.1 до 1 знака посл запятой*/
